...
The goal of this project was to develop a data visualization about crypto trading market data for analyzing trends and relations between measured traded crypto currencies. A functional document was created for the ideation of the data workflow and Power Bi visualization (see functional documents below or download it).
